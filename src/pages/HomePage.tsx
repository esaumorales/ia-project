...
export default function HomePage() {
  ...
  const filtered: EnrichedStudent[] = useMemo(() => {
    ...
    switch (orderBy) {
      ...
      case 'Estudio':
        arr = arr.sort(
          (a, b) => b.study_minutes_per_day - a.study_minutes_per_day
        );
        break;
      case 'Asistencia':
        arr = arr.sort(
        ...
        break;
      case 'Score':
        arr = arr.sort((a, b) => b.exam_score - a.exam_score);
        break;
    }
    return arr;
  }, [
  ...
  if (role === 'Landing') {
    return (
      <Landing
        onAlumno={() => setRole('Alumno')}
        onProfesor={() => setRole('Profesor')}
      />
    );
  }
    ...
    <div className="max-w-[1280px] mx-auto px-4 py-8 ">
      <div className="flex items-center justify-between">
        <h2 className="text-2xl font-semibold">
          Vista del Profesor <span className="text-gray-400 text-sm">○</span>
        </h2>
